...
const GROUPS: { label: string; match: (k: string) => boolean }[] = [
  ...
  { label: "Registration", match: (k) => k.startsWith("register") || k === "registration_form_config" || k === "whatsapp_group_url" || k.startsWith("group_discount") || k === "draft_batch_expiry_days" },
